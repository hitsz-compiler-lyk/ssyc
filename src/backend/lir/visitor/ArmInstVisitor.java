...
public interface ArmInstVisitor<T> {
    default T visit(ArmInst inst) {
        ...
        if (inst instanceof ArmInstLiteralPoolPlacement) { return visitArmInstLiteralPoolPlacement((ArmInstLiteralPoolPlacement) inst); }
    ...
    T visitArmInstLiteralPoolPlacement(ArmInstLiteralPoolPlacement inst);
